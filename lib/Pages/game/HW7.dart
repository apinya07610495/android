      ...
      child: Container(
          decoration: const BoxDecoration(
            image: const DecorationImage(
              image: const AssetImage("assets/images/tunasword.jpg"),
              fit: BoxFit
                          ...
                          child: Column(
                            children: [
                              for (var item = 0; item < count; item++)
                                Icon(Icons.star, size: 28.0, color: Colors.pinkAccent,),
                              for (var item = 0; item < 20 - count; item++)
                                Icon(Icons.star_border_outlined, size: 28.0, color: Colors.yellowAccent,)
                            ],
                          ),
                        ),
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                count.toString(),
                                style: TextStyle(fontSize: 120.0,  color: Colors.indigoAccent),
                              ),
                              press == 0
